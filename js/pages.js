...
function popHomepage() {
    ...
    var container = document.querySelector('#main-container');
        ...
        container.innerHTML = '<div class="homeMessages"><div class="message">Be Inspired..</div><br/>Browse a selection of webs best CSS, Click any item to copy its CSS directly</div>';
        // container.innerHTML =
